...
""", unsafe_allow_html=True)
        ...
        def render_single_kpi(label, subtitle=None, mode_override=None):
            # 1. Extraction des données (mode_override permet à un bouton de GROUPE de piloter cette carte)
        ...
        def render_pair_kpi(l_label, r_label, mode_override=None):
            ...
            # --- mode_override permet à un bouton de GROUPE de piloter cette paire ---
