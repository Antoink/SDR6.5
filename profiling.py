...
def get_column_stats(df, col_name):
    ...
    clean_series = df[col_name].astype(str).str.replace(',', '.')
    valid_values = pd.to_numeric(clean_series, errors='coerce').dropna()
        ...
        def afficher_section_1080():
            ...
            with c_1080_5: 
                ...
                if v15_raw and vgps_raw and vgps_raw > 0:
                    ...
                    html_pct = get_kpi_card_html(
                        ...
                        norm_color=c_pct, pct_color=c_pct, pct_html="<div style='color:#888; font-size:12px;'>-</div>", 
            ...
            if pdf_1080_files:
                ...
                if sel_pdf:
                    ...
                    with open(pdf_1080_path, "rb") as f:
                        pdf_1080_bytes = f.read()
                    ...
                    if st.button("🗎 AFFICHER LE RAPPORT PDF", key=f"btn_show_1080_pdf_{p_sel}", use_container_width=True):
