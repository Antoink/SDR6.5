...
# ==========================================
REPORT_NORMES = {
    "VMA": 18, "Vmax": 32, "CMJ 2JB": 40, "Peak Force CMJ": 2000,
    "Nordic": 0.4, "Adducteur": 4, "Knee To Wall (G)": 9, "Knee To Wall (D)": 9,
...
UNITS = {
    ...
    "Inverseur (G)": "N", "Inverseur (D)": "N", "Everseur (G)": "N", "Everseur (D)": "N",
